        ...
        <header class="header"> 
            <div class="container">
                ...
                <div class="header__content">
                    <h1 class="header__content-title">Organize it all with To-DoList</h1>
                    <a href="#" class="btn btn__login">Get started</a>
                </div>
            </div>
        </header>
                ...
                <div class="container">
                    <div class="features__block">
                        <div class="features__item">
                            <img class="features__item-img" src="/assets/img/feature-1.png" alt="">
                            <h3 class="features__item-title">Advanced Recurring Reminders</h3>
                            <p class="features__item-text">
                                Set up once & clear your mind. Reliable daily, weekly, monthly and yearly recurring tasks.
                            </p>
                        </div>
                        <div class="features__item">
                            <img class="features__item-img" src="/assets/img/feature-2.png" alt="">
                            <h3 class="features__item-title">Advanced Recurring Reminders</h3>
                            <p class="features__item-text">
                                Set up once & clear your mind. Reliable daily, weekly, monthly and yearly recurring tasks.
                            </p>
                        ...
                        <div class="features__item">
                            <img class="features__item-img" src="/assets/img/feature-3.png" alt="">
                            <h3 class="features__item-title">Advanced Recurring Reminders</h3>
                            <p class="features__item-text">
                                Set up once & clear your mind. Reliable daily, weekly, monthly and yearly recurring tasks.
                            </p>
                        ...
                        <div class="features__item">
                            <img class="features__item-img" src="/assets/img/feature-4.png" alt="">
                            <h3 class="features__item-title">Advanced Recurring Reminders</h3>
                            <p class="features__item-text">
                                Set up once & clear your mind. Reliable daily, weekly, monthly and yearly recurring tasks.
                            </p>
                        ...
                        <div class="features__item">
                            <img class="features__item-img" src="/assets/img/feature-5.png" alt="">
                            <h3 class="features__item-title">Advanced Recurring Reminders</h3>
                            <p class="features__item-text">
                                Set up once & clear your mind. Reliable daily, weekly, monthly and yearly recurring tasks.
                            </p>
                        ...
                        <div class="features__item">
                            <img class="features__item-img" src="/assets/img/feature-6.png" alt="">
                            <h3 class="features__item-title">Advanced Recurring Reminders</h3>
                            <p class="features__item-text">
                                Set up once & clear your mind. Reliable daily, weekly, monthly and yearly recurring tasks.
                            </p>
            ...
            <div class="feedbacks" id="feedback">
                <div class="container">
                    <div class="feedbacks__inner">
                        <h1>FEEDBACKS coming soon!</h1>
                    </div>
                </div>
            </div>

            <div class="feedbacks" id="download">
                <div class="container">
                    <div class="feedbacks__inner">
                        <h1>Application also...</h1>
                    </div>
                </div>
            </div>
