                ...
                <div class="container">
                    ...
                    <?php
                        ...
                        if( isset($data['do_signup'])) {
                            ...
                            if( R::count('users', "email = ?", array($data['email'])) > 0) {
                                $errors[] = 'Пользователь с таким emailом уже существует';
                            }
                            ...
                            if(empty($errors)) {
                                ...
                                $user -> password = md5($data['password'], PASSWORD_DEFAULT);
                                R::store($user);
                    ...
                    ?>
                        <form action="/signup.php" method="POST">
                            ...
                            <input type="password" name="password_2" placeholder="Confirm password" value="<?php echo @$data['password_2']; ?>">
                            <button type="submit" class="btn" name="do_signup">Sign Up!</button>
                        </form>
                    </div>
                </div>
            </div>
